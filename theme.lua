...
theme.taglist_bg_occupied = "#2d2d2d"
theme.taglist_fg_occupied = "#a7a7a7"

theme.taglist_bg_empty = "#2d2d2d" 

theme.taglist_fg_empty = "#605f61" 
